...
var (
	...
	ErrInvalidRSAPublicKey          = errors.New("key is of invalid type, expected key type: *rsa.PublicKey")
	ErrInvalidRSAPrivateKey         = errors.New("key is of invalid type, expected key type: *rsa.PrivateKey")
	ErrInvalidECDSAPublicKey        = errors.New("key is of invalid type, expected key type: *ecdsa.PublicKey")
	ErrInvalidECDSAPrivateKey       = errors.New("key is of invalid type, expected key type: *ecdsa.PrivateKey")
	ErrInvalidHMACKey               = errors.New("key is of invalid type, expected key type: []byte")
